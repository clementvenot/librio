...
@Schema(
    name = "BigListBookResponseDto",
    description = "Représentation concise d’un livre pour les listes (grandes listes de résultats)."
)
public class BigListBookResponseDto {
    ...
    @Size(max = 500)
    @Schema(
        description = "Auteur(s) du livre (chaîne plate ou séparée par des virgules).",
